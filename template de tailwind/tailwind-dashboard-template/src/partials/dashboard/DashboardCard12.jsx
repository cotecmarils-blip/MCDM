        ...
        <div>
          ...
          <ul className="my-1">
            ...
            <li className="flex px-2">
              <div className="w-9 h-9 rounded-full shrink-0 bg-blue-900 my-2 mr-3">
              ...
              <div className="grow flex items-center border-b border-gray-100 dark:border-gray-700/60 text-sm py-2">
                <div className="grow flex justify-between">
                  ...
                  <div className="shrink-0 self-end ml-2">
                    <a className="font-medium text-blue-900 hover:text-violet-600 dark:hover:text-violet-400" href="#0">View<span className="hidden sm:inline"> -&gt;</span></a>
                  </div>
                </div>
              </div>
            </li>
