      ...
      >
        ...
        >
          ...
          <ul>
            <li>
              <Link
                className="font-medium text-sm text-blue-900 hover:text-violet-600 dark:hover:text-violet-400 flex items-center py-1 px-3"
                to="#0"
                onClick={() => setDropdownOpen(!dropdownOpen)}
              >
                <svg className="w-3 h-3 fill-current text-blue-900 shrink-0 mr-2" viewBox="0 0 12 12">
