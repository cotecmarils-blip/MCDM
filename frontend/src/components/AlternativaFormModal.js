...
function AlternativaFormModal({ proyectoId, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await alternativas.create(payload);
      onSuccess();
    } catch (err) {
      console.error('Error creando alternativa:', err);
      alert('Error al crear la alternativa');
    } finally {
      setLoading(false);
    }
  };
...
export default AlternativaFormModal;
